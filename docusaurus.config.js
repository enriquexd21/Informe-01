...
const config = {
  ...
  organizationName: 'enriquexd21',
  projectName: 'informe-01',
    ...
    ({
      ...
      navbar: {
        ...
        logo: {
          ...
          src: 'https://www.shutterstock.com/image-vector/fortnite-logo-prepared-cleaned-vector-260nw-2391666679.jpg',
        },
        items: [
          // {
          //   type: 'docSidebar',
